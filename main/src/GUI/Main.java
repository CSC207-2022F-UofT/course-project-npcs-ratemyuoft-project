...
public class Main extends javax.swing.JFrame {
    ...
    public Main()  {
        ...
        login.addEventUserTriesToLogIn(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                // Pass data to controller and try to log in
                controller.userLogin(login.getUserName(), login.getPassword());

            }
        });
        register.addEventUserTriesToRegister(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                controller.userRegister(register.getUserName(), register.getPassword(), register.getMajor(),
                        register.getStartYearOfStudy());
            }
        });
